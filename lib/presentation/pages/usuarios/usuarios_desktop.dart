        ...
        child: SingleChildScrollView(
          ...
          child: SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                DataColumn(label: Text('USUARIO', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('EMAIL', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('ROL', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('ESTADO', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('COINS', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('VISTO', style: const TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('ACCIONES', style: const TextStyle(fontWeight: FontWeight.bold))),
              ],
